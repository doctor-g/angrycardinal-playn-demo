package edu.bsu.pvgestwicki.robovm;
...
public class AngryCardinalGameRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, AngryCardinalGameRoboVM.class);
    pool.close();
  }
}
